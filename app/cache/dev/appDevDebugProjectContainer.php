...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a75df92cd12137ae1b393e50308ae3013244539c89bb18598048775be8a1a4b7');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js|login)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '58da5d094e9ac6.56238969', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), '/login', NULL, $c, false));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'app.admin.blogpost', 1 => 'app.admin.user', 2 => 'app.admin.category'));
        $instance->setAdminGroups(array('sonata_page' => array('label' => 'Gestion des catégories', 'label_catalogue' => 'AppBundle', 'items' => array(0 => array('admin' => 'app.admin.category', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array())), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'item_adds' => array(), 'roles' => array()), 'sonata_page2' => array('label' => 'Gestion des blogs', 'label_catalogue' => 'AppBundle', 'items' => array(0 => array('admin' => 'app.admin.blogpost', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array())), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'item_adds' => array(), 'roles' => array()), 'sonata_page3' => array('label' => 'Gestion des utilisateurs', 'label_catalogue' => 'AppBundle', 'items' => array(0 => array('admin' => 'app.admin.user', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true, 'roles' => array())), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'item_adds' => array(), 'roles' => array())));
        $instance->setAdminClasses(array('AppBundle\\Entity\\BlogPost' => array(0 => 'app.admin.blogpost'), 'AppBundle\\Entity\\User' => array(0 => 'app.admin.user'), 'AppBundle\\Entity\\Category' => array(0 => 'app.admin.category')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'app.admin.blogpost', 1 => 'app.admin.user', 2 => 'app.admin.category'), $this);
    }
