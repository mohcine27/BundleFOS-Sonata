...
class BlogPost extends \AppBundle\Entity\BlogPost implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BlogPost' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\BlogPost' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\BlogPost' . "\0" . 'body', '' . "\0" . 'AppBundle\\Entity\\BlogPost' . "\0" . 'draft', '' . "\0" . 'AppBundle\\Entity\\BlogPost' . "\0" . 'category');
        }
